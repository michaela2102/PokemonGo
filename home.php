...
<body>
    ...
    <li><a href="create_account.php">New user? Create an account</a><img src="images/pika.png" alt="Pikachu Icon" width= "35" height="35"></li><br>
    <li><a href="leaderboard.php">View the leaderboard</a><img src="images/char.png" alt="Ditto Icon" width= "35" height="35"></li><br>
    <li><a href="trading_page.php">View the pokemon trading page</a><img src="images/dit.png" alt="Charmander Icon" width= "35" height="35"></li><br>
